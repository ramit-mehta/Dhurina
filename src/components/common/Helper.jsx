...
export const Company = [
  ...
  { label: "Media", url: "#" },
  { label: "Careers", url: "#" },
  { label: "Careers For Faculties", url: "#" },
  { label: "Franchise", url: "#" },
  { label: "Content Partner", url: "#" },
  { label: "Online Support", url: "#" },
];
export const Courses = [
  { label: "Banking & Insurance", url: "#" },
  { label: "SSC", url: "#" },
  { label: "Railways", url: "#" },
  { label: "Teaching", url: "#" },
...
export const Products = [
  { label: "Demo Videos", url: "#" },
  { label: "E-Books", url: "#" },
  { label: "Test Series", url: "#" },
  { label: "Boost Skill", url: "#" },
  { label: "Books", url: "#" },
];
...
// BIHAR ALL LIVE COURSES
export const BiharAllLiveCourses = [
  {
    img: Icon,
    Title: "BIHAR",
    type: "Patna High Court",
